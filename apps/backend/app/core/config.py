...
class Settings(BaseSettings):
    ...
    FOLKS_HUB: str = "0xb39c03297E87032fF69f4D42A6698e4c4A934449"
    FOLKS_MESSAGE_MANAGER: str = "0xFc828C500c90E63134B2B73537cC6cADfF4Ce695"
    ...
    FOLKS_ACCOUNT_NONCE_SCAN_MAX: int = 128
    FOLKS_LOAN_NONCE_SCAN_MAX: int = 8
    FOLKS_ROUTE_RESOLVE_TIMEOUT_SECONDS: float = 6.5
    ...
    PROTOCOL_BALANCE_READ_TIMEOUT_SECONDS: float = 8.0  # Per-protocol balance read timeout
