...
export default function GettingStartedPage() {
  return (
    <article className="prose max-w-none">
      ...
      <p className="lead">
        Deposit USDC and start earning optimized yield on Avalanche in under a minute.
      </p>
      ...
      <h2>Step 3: Select Markets</h2>
      <p>
        Turn on all the protocols you would like your agent to interact with. SnowMind will only
        route and rebalance across the markets you enable.
      </p>

      <h2>Step 4: Grant a Session Key</h2>
      <p>
      ...
      <h2>Step 6: Monitor on the Dashboard</h2>
      <p>
