...
/**
 * @title DeployMainnet
 * @notice Deploy ONLY the SnowMindRegistry on Avalanche C-Chain mainnet (43114).
 ...
 *   3. Transfer ownership to Gnosis Safe multisig (two-step):
 *      Step 1: cast send <REGISTRY_ADDRESS> "proposeOwnership(address)" <GNOSIS_SAFE_ADDRESS> \
 *        --rpc-url avalanche --private-key $DEPLOYER_PRIVATE_KEY
 *      Step 2: Accept from the Gnosis Safe by calling acceptOwnership()
 */
contract DeployMainnet is Script {
    function run() external {
        ...
        console.log("Chain ID:         43114 (Avalanche C-Chain)");
        ...
        console.log("");
        console.log("=== LIVE PROTOCOL ADDRESSES (DO NOT REDEPLOY) ===");
        ...
        console.log("");
        console.log("=== NEXT STEP: TRANSFER OWNERSHIP TO GNOSIS SAFE ===");
        console.log("Step 1 (propose):");
        console.log("  cast send <REGISTRY> 'proposeOwnership(address)' <SAFE> --rpc-url avalanche --private-key $DEPLOYER_PRIVATE_KEY");
        console.log("Step 2 (accept from Safe):");
        console.log("  Call acceptOwnership() from the Gnosis Safe multisig");
    }
}
